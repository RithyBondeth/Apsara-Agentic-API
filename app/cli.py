...
async def init_workspace(args: argparse.Namespace, config: CliConfig) -> int:
    ...
    if config_path.exists() and not args.force:
        ...
        config_text = render_project_config_toml(
    ...
    added_gitignore_entries = ensure_gitignore_entries(
        workspace_root,
        [".apsara/", ".apsara-cli/"],
    )
    if added_gitignore_entries:
        ui.info(
            "Updated .gitignore with "
            + ", ".join(added_gitignore_entries)
        )

    env_path = workspace_root / ".env"
    if not env_path.exists():
        ui.warning(
            "No .env file was found in this project. Add OPENAI_API_KEY before live model use."
        )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    init_parser = subparsers.add_parser(
        "init",
        help="Initialize Apsara in the current project and open chat.",
    )
